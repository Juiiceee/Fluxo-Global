            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
              ...
              <div className="space-y-4 max-w-md">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  Ask questions, explore ideas, or engage in creative discussions.
                </p>
                ...
                <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 px-6 py-4 rounded-3xl rounded-tl-lg shadow-lg backdrop-blur-sm">
                  <div className="flex items-center space-x-4">
                    <div className="flex space-x-1">
                      ...
                      <div className="w-2 h-2 bg-gradient-to-r from-gray-600 to-gray-700 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                      <div className="w-2 h-2 bg-gradient-to-r from-gray-600 to-gray-700 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                    </div>
